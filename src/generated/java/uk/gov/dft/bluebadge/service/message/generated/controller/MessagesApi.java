...
public interface MessagesApi {
  ...
  @ApiOperation(
    ...
    notes = "Sends an email of a specific template to the specified user",
  ...
  @ApiResponses(
    value = {
      @ApiResponse(
        code = 200,
        message = "Success - A message has been created and sent.",
        response = UuidResponse.class
      ),
  ...
  default ResponseEntity<UuidResponse> sendMessage(
